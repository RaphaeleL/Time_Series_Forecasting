...
Description:
This module resolves the hyper_parameter_optimizer the user passes as string over the command line to the actual hyper_parameter_optimizer ORacle from keras_tuner
These Optimizers define how and which hyperparameters will be tried in the hyperparameter optimization
An Oracle is a keras_tuner Class. It is basicly the Keras_tuner hyper_parameter_optimizer class which takes own arguments itself
