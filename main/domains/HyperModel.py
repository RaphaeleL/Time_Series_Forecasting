...
from domains.factories import (
    NeuronalNetworkModelFactory as NNMFactory,
    HyperModelFactory as HMPFactory,
)
...
class HyperModel(kt.HyperModel):
    ...
    def build(self, hp):
        ...
        # Declaration is required here because the keras_tuner checks for hyperparameters only in the build function,
        # if these two variables are not here the keras_tuner will not test them in the first Trial!
        epochs = hp.Int(
            "epochs",
    ...
    def fit(self, hp, model, *args, **kwargs):
        ...
        *args, **kwargs are all parameters that are not modified in this overwritten version of fit,
        ...
        args:
            ...
            *args: Parameters before epochs and batchsize
            **kwargs: Parameters after epochs and batchsize
        returns:
